  ...
  return (
    <div className="relative w-full max-w-[200px] mx-auto">
      <svg viewBox="0 0 200 180" className="w-full h-auto">
        ...
        {/* Tronc cérébral */}
        <path d="M95 155 Q90 170 95 180 M105 155 Q110 170 105 180" fill="none" stroke="var(--border)" strokeWidth="2" />
      ...
      <div className="mt-4 space-y-1 text-xs">
        <div className="flex items-center gap-2">
          <div
            ...
            style={{ backgroundColor: level1Progress > 0 ? "var(--neon-cyan)" : "var(--muted)" }}
          />
          <span className="text-muted-foreground text-lg">Novice: {Math.round(level1Progress)}%</span>
        </div>
        <div className="flex items-center gap-2">
          <div
            className="w-3 h-3 rounded-full"
            style={{ backgroundColor: level2Progress > 0 ? "var(--neon-orange)" : "var(--muted)" }}
          />
          <span className="text-muted-foreground text-lg">Praticien: {Math.round(level2Progress)}%</span>
        </div>
        <div className="flex items-center gap-2">
          <div
            className="w-3 h-3 rounded-full"
            style={{ backgroundColor: level3Progress > 0 ? "var(--neon-purple)" : "var(--muted)" }}
          />
          <span className="text-muted-foreground text-lg">Expert: {Math.round(level3Progress)}%</span>
        </div>
      </div>
    </div>
  )
