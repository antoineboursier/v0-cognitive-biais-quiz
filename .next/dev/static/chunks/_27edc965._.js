...
function quizReducer(state, action) {
    switch(action.type){
        case "START_LEVEL":
            {
                const levelQuestions = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTIONS"].filter((q)=>q.level_id === action.payload.id);
                return {
                    ...state,
                    gameState: "playing",
...
//# sourceMappingURL=_27edc965._.js.map